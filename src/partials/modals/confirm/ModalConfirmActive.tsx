...
const ModalConfirmActive = forwardRef<HTMLDivElement, ModalActiveProps>(({ open, onClose, onConfirm, title, message }, ref) => {
      ...
      <ModalContent className="max-w-[600px] top-[15%]">
        ...
        <ModalBody className="py-4 px-5">
          ...
          <div className='w-full flex gap-2 justify-end pt-4'>
            ...
            <button onClick={onConfirm} className='py-2 px-3 border border-[#F4F4F4] rounded text-base font-bold bg-[#DFA000] text-white'>
              Đồng ý
            </button>
          </div>
        </ModalBody>
