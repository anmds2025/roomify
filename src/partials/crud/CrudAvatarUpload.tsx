...
interface CrudAvatarUploadProps {
  ...
  onAvatarChange?: (avatar: IImageInputFile[]) => void;
}

const CrudAvatarUpload: React.FC<CrudAvatarUploadProps> = ({ initialAvatarUrl, onAvatarChange }) => {
  const [avatar, setAvatar] = useState<IImageInputFile[]>([
    { dataURL: initialAvatarUrl || "https://my-bucket-kiai-image.s3.ap-southeast-1.amazonaws.com/uploads/user-default.png" }
  ]);
