            ...
            <div className="space-y-4">
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  <KeenIcon icon="pencil" className="w-5 h-5 text-gray-400" />
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-600">Chữ ký</p>
                    {(user as any)?.image_signature ? (
                      <div className="mt-2">
                        <img 
                          src={(user as any).image_signature} 
                          alt="Chữ ký" 
                          className="max-w-xs h-16 object-contain border border-gray-200 rounded bg-gray-50 p-2"
                        />
                      </div>
                    ) : (
                      <p className="text-sm text-gray-800">Chưa có chữ ký</p>
                    )}
                  </div>
                </div>
              </div>
